...
![Test Image Encoded](./images/test-image-with-spaces.png)
...
<img src="./images/test-image-with-spaces.png" alt="Test Image HTML Encoded">
...
[Download Image Encoded](./images/test-image-with-spaces.png)

## Wikilink to Image as Asset

Wikilink reference to image as asset:
[images/test image with spaces.png](images/test-image-with-spaces.png)
